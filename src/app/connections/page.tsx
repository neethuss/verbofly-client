...
const ConnectionsPage = () => {
  ...
  return (
    ...
    <main className="flex-1 flex flex-col items-center p-4 md:p-8 w-full max-w-6xl mx-auto lg:ml-24 md:ml-20">
      <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 flex items-center">
        <FaUsers className="mr-3 text-yellow-400" /> Your Connections
      </h1>

      <div className="w-full">
        <div className="bg-gray-800 rounded-lg p-4 md:p-6 mb-6 md:mb-8 shadow-lg">
          ...
          {filteredConnections && filteredConnections.length > 0 ? (
              ...
              {filteredConnections.map((connection) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-2 mt-4">
                    ...
                    <button
                      onClick={() => router.push(`/nativeSpeakers/${connection?._id}`)}
            ...
            <div className="text-center py-8 md:py-12">
              <FaUsers className="mx-auto text-gray-400 text-4xl md:text-5xl mb-4" />
